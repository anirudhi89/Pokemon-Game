class User(object):
    ...
    def list_pokemon(self):
        ...
        # create empty list, append list to that list
        listOfList = []
        ...
        #loop that prompts user three times, one for each region, so it will pick three pokemon to use
        for i in listOfList:
